...
jQuery(document).ready(function(){
  ...
  jQuery(".js-added").live("click",function(e){
    ...
    if(bu.hasClass('remove-button')){
      ...
      //if this was a info panel add, copy the item in to the existing files block
      if(!checkbox_ele.hasClass('joined_field')){
        ...
        tag_option_str += "
          <div class='join_title'>
            <input type='text' name='"+tag_pattern.replace("%s", fid)+"[title]' value='' placeholder='caption'>
          </div>
        </div>";
