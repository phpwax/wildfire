...
updateMeta = function (meta) {
	...
	if(meta.file) {
		...
		$('meta').innerHTML += ' <table>
															<tr>
																<td class="l">Name</td>
																<td><input type="text" name="filename" onfocus="window.onkeypress=\'null\'"; id="metaFilename" value="'+meta.filename+'" /></td>
															</tr>
															<tr>
																<td class="l">Kind</td>
																<td>'+meta.type+'</td>
															...
															<tr>
																<td class="l">Where</td>
																<td><div style="width:115px; overflow:hidden"><a href="'+FC.SCRIPTSRC+'?path='+meta.path+'/'+meta.filename+'">'+path+' /'+meta.filename+'</a></div></td>
															</tr>
															<tr>
															...
															<tr>
																<td class="l">Flag</td>
																<td><select id="metaFlag" name="metaFlag" id="metaFlag">'+metaFlags+'</select></td>
															</tr>
															<tr>
																<td class="l"><a href="#" onclick="saveMeta(); return false"><img src="'+saveIcon+'" alt="" /></a></td>
																<td><textarea name="description" onfocus="window.onkeypress=\'null\'"; id="metaDesc">'+meta.description+'</textarea></td>
															</tr>
														</table>';
	}
