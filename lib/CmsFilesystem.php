  ...
  function getMeta($fileid){
    ...
    $this->jsonAdd("\"edit\": \"true\"");
  	...
  	if($imginfo = getimagesize($fileinfo['path'].'/'.$fileinfo['filename'])) {
			$meta.=", \"rotate\": \"<a href='/admin/files/rotate/$fileid?angle=-90' class='rotate' onclick='rotate_image();'>left</a>&nbsp;<a href='/admin/files/rotate/$fileid?angle=90' class='rotate' onclick='rotate_image();'>right</a>\"";
