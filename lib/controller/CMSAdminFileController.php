...
class CMSAdminFileController extends CMSAdminComponent {
  ...
  public function file_tree($directory, $return_link, $extensions = array()) {
  	...
  	$code = "<ul id='php-file-tree' class='filetree'><li>";
		...
		foreach( $file as $this_file ) {
			if( $this_file != "." && $this_file != ".." ) {
				if( is_dir("$directory/$this_file") ) {
					// Directory
					$php_file_tree .= "<li class=\"folder\"><a href=\"#\" id='".$this->unslashify($directory."/".$this_file)."' class='tree_folder'><span>" . htmlspecialchars($this_file) . "</span></a>";
