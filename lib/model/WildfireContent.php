...
class WildfireContent extends WaxTreeModel {
	...
	public function setup(){
	  $this->define("status", "IntegerField", array('maxlength'=>2, "widget"=>"SelectInput", "choices"=>array(0=>"Draft/Revision",1=>"Live"), 'scaffold'=>true, 'group'=>'main details'));
		$this->define("title", "CharField", array('maxlength'=>255, 'scaffold'=>true, 'group'=>"main details") );
		$this->define("excerpt", "TextField");
		$this->define("content", "TextField", array('group'=>'main details'));
