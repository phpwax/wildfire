...
class WildfireContent extends WaxTreeModel {
  ...
  public static $layout_listing_cache = array();
	...
	public function setup(){
		...
		$this->define("date_start", "DateTimeField", array('default'=>date("Y-m-d h:i:s"), 'output_format'=>"j F Y",'save_format'=> 'j F Y H:i', 'info_preview'=>1));
		$this->define("date_end", "DateTimeField", array('default'=>date("Y-m-d h:i:s",mktime(0,0,0, date("m"), date("j"), date("y")-10 )), 'output_format'=>"j F Y", 'save_format'=> 'j F Y H:i','info_preview'=>1));
